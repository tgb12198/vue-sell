        ...
        <div v-show="detailShow" class="detail">
          <div class="detail-wrapper clearfix">
            <div class="detail-main">
              ...
              <discounts :supports="seller.supports" :size="1"></discounts>
              <div class="title">
                <div class="line"></div>
  ...
  .header
    ...
    .detail
      ...
      .detail-wrapper
        ...
        .detail-main
          margin-top: 64px
          padding-bottom: 64px //padding-bottom和footer里的负margin值要保持一致
      ...
      .detail-close
        ...
        width: 32px
        height: 32px
        margin: -64px auto 0 auto //padding-bottom和footer里的负margin值要保持一致
        clear: both
        font-size: 32px
</style>
